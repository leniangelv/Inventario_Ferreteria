  ...
  <div class="col-md-9">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="col-md-12">
          <form method="post" action="add_product.php" id="form-add" class="clearfix">
            ...
            <button type="submit" name="add_product" id="btn-add" class="btn btn-danger">Agregar producto</button>
          </form>
        </div>
      </div>
    </div>
