...
class Media {
  ...
  public $upload_errors = array(
    ...
    3 => 'El archivo subido fue solo parcialmente subido',
 ...
 /*--------------------------------------------------------------*/
 /* Función para procesar el archivo multimedia
 /*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
/* Función para insertar la imagen multimedia
/*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
   public function media_destroy($id,$file_name){
     ...
     if(delete_by_id('media',$id)){
       ...
       $this->errors[] = "Se ha producido un error en la eliminación de fotografías.";
       return false;
     }
   }
}
